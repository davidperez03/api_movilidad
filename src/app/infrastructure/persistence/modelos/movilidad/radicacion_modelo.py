...
class RadicacionModelo(Base):
    ...
    organismo_origen_id: Mapped[_UUID | None] = mapped_column(
    ...
    estado: Mapped[str] = mapped_column(
        ...
        nullable=False, default=EstadoRadicacion.SIN_ASIGNAR.value,
    )
    numero_guia: Mapped[str | None] = mapped_column(String(100), nullable=True)
    numero_guia_devolucion: Mapped[str | None] = mapped_column(String(100), nullable=True)
    observaciones: Mapped[str | None] = mapped_column(Text, nullable=True)
    radicado_en: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
